...
public class PaperComponent implements NightComponent {
    ...
    @NotNull
    public static PaperComponent translate(@NotNull String key, @Nullable String fallback) {
        return new PaperComponent(Component.translatable(key, fallback));
    }
    ...
    public void setChildrens(@NotNull List<NightComponent> childrens) {
        this.parent = this.parent.children(childrens.stream().map(PaperBridge::fromNightComponent).toList());
    }

    @Override
    public void addChildren(@NotNull NightComponent other) {
        this.parent = this.parent.append(PaperBridge.fromNightComponent(other));
    }
...
//                event = itemStack == null ? null : itemStack.asHoverEvent();
//            }
//        }
...
//    }
    ...
    @Override
    public void setHoverEvent(@NotNull NightComponent text) {
        Component component = PaperBridge.fromNightComponent(text);
        this.parent = this.parent.hoverEvent(HoverEvent.showText(component));
    }

    @Override
    public void setHoverEvent(@NotNull ItemStack itemStack) {
        this.parent = this.parent.hoverEvent(itemStack.asHoverEvent());
    }
